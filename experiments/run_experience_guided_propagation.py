...
def main() -> None:
    parser = argparse.ArgumentParser(description="Experiment 015: Experience-guided Propagation")
    ...
    output = Path("results") / "experiment_015"
    rows: list[dict[str, object]] = []

    print("Experiment 015: Experience-guided Propagation")
    print("training: A -> P and F -> P")
    print("comparison: local plasticity vs experience-guided propagation")
    ...
    write_csv(output / "experience_guided_propagation_curve.csv", rows)
    final = [
        row for row in rows
